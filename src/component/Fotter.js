...
function Fotter() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_aw59fbd", "template_fyuxrdd", form.current, {
  ...
  return (
    <div className="overflow-hidden border-t-2 flex-col flex w-full justify-center items-center flex-wrap bg-secondary-bg-color p-8">
      <FloatButton.BackTop
        ...
        tooltip={<b>Back Top</b>}
      />

      <div className="flex md:flex-row flex-col overflow-hidden md:gap-x-14 gap-y-3 md:mr-0 w-full items-center justify-center">
        <div
          class=" group before:absolute before:bg-sky-500 before:w-3 before:h-12 overflow-hidden
              ...
              <div class="group-hover:duration-300 hover:opacity-100  opacity-0 before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative   flex flex-col justify-around items-center w-44 h-40 bg-neutral-900 text-gray-50">
                ...
                <div class="text-gray-50 w-48 flex flex-row justify-evenly">
                  ...
                  <div class="flex flex-row items-center">
                    <svg
                      class="w-5 h-5 fill-red-500 animate-bounce"
                      height="100"
        ...
        <div className="w-full md:w-auto flex justify-center items-center overflow-hidden ">
          ...
          >
            ...
            <div class="flex gap-1">
              ...
              <button
                className="bg-violet-500 text-neutral-50 md:p-2 p-0 rounded-lg hover:bg-violet-400"
                type="submit"
              >
                {t("Subscribe")}
              </button>
      ...
      <p className="mt-6 text-center text-base">
        {t("Copyright")} &copy; 2024 {t("by")} Vu Hoang <span>Dev</span> |{" "}
