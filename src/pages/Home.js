...
function Home() {
  ...
  const handleSendComment = async (values, e) => {
    ...
    try {
      const formURL =
        "https://docs.google.com/forms/d/e/1FAIpQLSflhgHoZvom5pzC0aiEDKIguU7k2ABWTWroq1qA8KclPDZrCA/formResponse"; // Google Form URL
  ...
  const getComment = async () => {
    ...
    try {
      const reponse = await axios.get(
        `https://script.google.com/macros/s/AKfycbwVTMsw9F1W8bpvD9cTZ0Eodp-TbJwMUyPGTcFyYDUfKAdXoBK76lFiRyCkKtMAHJM/exec`
      );
  ...
  const renderComments = () => {
    ...
    return reversedComments.map((cmt, index) => {
      ...
      return (
        <div
          className="flex-col flex w-full border-2 my-3 p-2 rounded-2xl snap-y scroll-smooth focus:scroll-auto"
          key={index}
        >
          ...
          <p className="text-start font-thin text-[10px]">
            This [{cmt.email}] left a comment 👇👇{" "}
          </p>
          <b className="text-start mt-5">
            {t("Comment")}
  ...
  return (
    <div
      className={`snap-y snap-mandatory justify-center overflow-hidden items-center flex w-full flex-col ${
        darkMode ? "" : "dark"
      }`}
    >
      <ProgressBar />
      ...
      <div className="snap-start  mt-auto md:h-screen  w-full flex justify-center items-center md:flex-row flex-col">
        <div
          ...
          className={`
               ${
                 darkMode ? "shadow-orange-50" : "border-white"
               }  border-2 shadow-black 
        ...
        >
            ...
            <div className="flex flex-col ">
              <div className="flex flex-row">
                <b
                 ...
                 bg-gradient-to-br from-purple-900 via-pink-700 to-yellow-400 text-[50px]"
                >
                  <ExampleComponent /> {t("I am")}
                </b>
              </div>
              <span
                className=" text-transparent bg-clip-text font-bold
                 bg-gradient-to-br from-purple-900 via-pink-700 to-yellow-400 text-4xl animate-pulse pb-5"
              >
                {t("Vu Huy Hoang")}
              </span>
              <br></br>
              ...
              <span className="text-5xl ">
                ...
                <marquee
                  ...
                  width="100%"
                  behavior="scroll"
                  className="text-sky-600 font-bold mt-2 md:w-[500px] rounded-xl"
                >
                  {" "}
                  {t("Developer")}
                </marquee>
            ...
            <div className="space-x-8 flex flex-row ">
              <Popover trigger="hover" content={<b>Github</b>}>
                <Button
                  ...
                  className="rounded-full hover:bg-sky-300 bg-white hover:animate-none border-2
                      border-black animate-bounce"
                  href="https://github.com/2602hoang"
                  title={t("Github me")}
                  type="link"
              ...
              <Popover trigger="hover" content={<b>Email</b>}>
                <Button
                  ...
                  href="mailto:vuhuyhoangboj@gmail.com"
                  title={t("Gmail me")}
                  type="link"
              ...
              <Popover trigger="hover" content={<b>FaceBook</b>}>
                <Button
                  ...
                  target="_blank"
                  className="rounded-full hover:bg-sky-300 bg-white hover:animate-none border-2 border-black animate-bounce"
                  href="https://www.facebook.com/VHH26022001"
                  title={t("Facebook me")}
                  type="link"
                  icon={<FacebookFilled style={{ color: "black" }} />}
                />
              </Popover>
              <Popover
                overlayInnerStyle={{
                ...
                content={
                  <div>
                    <h1 className="text-center uppercase text-black ">
                      {t("Zalo me")}!!!
                    </h1>
                    <QRCode
                      value="https://zalo.me/0917789964"
                      title="Zalo Me"
                      bordered={false}
                    />
                  </div>
              ...
              >
                <Button
                  ...
                  title={t("Call me")}
                  type="text"
                  icon={<PhoneFilled style={{ color: "black" }} />}
                >
                  091778994
                </Button>
              </Popover>
          ...
          <div
            data-aos="flip-down"
            className={`  md:ml-40 justify-center items-center  ${
              darkMode ? "" : "dark"
            }    mb-10 flex md:w-[400px]   `}
          >
            {/* <img className={`
            ...
            >
              ...
              {/* https://drive.google.com/file/d/1_DJ7hrlyBC3QmYWy3F7JUD-LB6upYKDt/view */}
              <button
                target="_blank"
                onClick={() => {
                  window.open(
                    "https://drive.google.com/file/d/1equBGJptSHXs8S6JVuKSeD-hxw-4hIa-/view?usp=sharing",
                    "_blank"
                  );

                  // Trigger the file download
                  window.location.href =
                    "https://drive.google.com/uc?export=download&id=1equBGJptSHXs8S6JVuKSeD-hxw-4hIa-";
                }}
                class="
      ...
      {/* 3 */}
      <div
        className="md:h-screen  snap-start  w-full flex justify-center items-center mt-16 md:mt-0"
        data-aos="flip-left"
      ...
      >
        <div class={`card  `}>
          <div
            class={`relative border-2 border-sky-400 shadow-2xl ${
              darkMode ? "shadow-black" : "shadow-white"
            } w-[300px]   sm:w-[650px] group transition-all duration-700
          ...
          >
            ...
            >
              ...
              <div class="group duration-500 hover:-skew-x-0 skew-x-6 hover:translate-x-2">
                <div
                  class="group-hover:duration-400 relative rounded-2xl  w-[auto] h-10 bg-white text-gray-50 flex flex-col justify-center
      ...
      <h1 className="text-center text-2xl font-bold text-yellow-400 my-6">
        {t("Please contribute with your comments")}
      </h1>
      <div
        data-aos="flip-down"
        className="mb-5 snap-start  flex flex-col md:h-screen justify-center items-center  md:mt-auto mx-2"
      >
        ...
        >
          ...
          <button
            onClick={showModal1}
            class="bg-red-300 hover:bg-red-500 text-white animate-bounce 
          ...
          >
            <div
              id="cmt_input"
              className="md:w-full w-full md:space-y-6 items-center flex-col justify-center flex"
            >
              <h1 className="text-[#99ff33] font-serif text-4xl animate-bounce font-semibold">
                {t("Your comment")}
              </h1>
              <Form
                form={form1}
                className="flex w-2/3 flex-col md:mx-0 md:w-full md:px-8 h-auto justify-center items-center"
                ...
                <div className="w-full md:w-full md:pl-[110px] md:pr-4 ">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: t("Please input your comment!"),
                      },
                    ]}
                  >
                    <TextArea
          ...
          <div
            id="commentWrapper"
            className="overflow-y-hidden hover:overflow-y-auto h-[600px]  w-full md:w-1/2 mt-5  "
          >
            {comment !== undefined ? renderComments() : <div>aaaaaa</div>}
          </div>
        </div>
      </div>
