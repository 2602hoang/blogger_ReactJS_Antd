...
function Skill() {
  ...
  return (
    <div
      className={`justify-center  overflow-hidden items-center flex w-full flex-col ${
        darkMode ? "" : "dark"
      }`}
    >
      <ProgressBar />
          ...
          <div className="flex md:mx-20 mx-2 ">
            <div className="    mt-8 min-h-screen w-full h-auto flex justify-center items-center  flex-col">
              <b
                className=" flex justify-center items-center
                      ...
                      bg-gradient-to-br
                        ...
                        text-center animate-pulse uppercase"
              >
                {t("SKILLS ABOUT ME")}
              </b>
              <div className="flex flex-col justify-center items-center">
                ...
                >
                  <h1 className="text-sky-300 text-center font-extrabold mt-12 animate-pulse border-t-2 text-5xl">
                    {t("Programming Skills")}
                  </h1>
                  <div class="flex-col  flex text-center justify-center items-center   ">
                    <div class="animate-float-image gap-4 hover:animate-none my-10 mt-28 mx-2 md:flex-row  md:space-y-0 space-y-5  flex-wrap flex-col flex text-center justify-center items-center space-x-2  w-auto">
                      <div class="text-[18px] shadow-white shadow-2xl px-3 bg-pink-200 text-pink-800 rounded-full">
                        ⭐
                      </div>
                      {Object.entries(listSkillWithColors).map(
                        ([item, skillColor], index) => {
                          return (
                            <div
                              key={index}
                              className="text-[18px] border-2  shadow-white shadow-2xl px-3 rounded-full"
                              style={{
                ...
                >
                  <div class="profileCard_container relative p-10 border-2 border-dashed rounded-full border-spacing-4 border-gray-400/50">
                    ...
                    <button class="profile_item -left-4 top-20 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500">
                      <span class="block w-[40px] h-[40px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
                        <Tooltip color="orange" title="HTML" placement="left">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="32"
                            height="32"
                    ...
                    <button class="profile_item bottom-8 -left-0 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500">
                      <span class="block w-[40px] h-[40px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
                        <Tooltip color="orange" placement="left" title="CSS">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                            y="0px"
                ...
                <div
                  ...
                  className="flex-col flex justify-center items-center"
                >
                  <h1 className="text-sky-300 mt-12 font-extrabold text-6xl text-center border-t-2 animate-pulse">
                    {t("Soft Skills")}
                  </h1>
                  <div class=" my-5 flex-col md:flex-row flex text-center justify-center items-center flex-wrap  ">
                    {/* <marquee behavior	="alternate" direction="right"> */}
                    <div
                      class="animate-float-image hover:animate-none my-10 mt-28 space-x-5  md:flex-row md:space-y-0 space-y-5 flex-col flex   text-center
                                                    justify-center items-center   w-auto "
                    >
                      <div class="text-xl shadow-white shadow-2xl px-3 bg-indigo-200 text-indigo-800 rounded-full">
                        {t("Inquisitive, progressive")}
                      </div>
                      <div class="text-xl shadow-white shadow-2xl px-3 bg-red-200 text-red-800 rounded-full">
                        {t("Work under pressure")}
                      </div>
                      <div class="text-xl shadow-white shadow-2xl px-3 bg-orange-200 text-orange-800 rounded-full">
                        {t("Teamwork")}
                      </div>

                      <div class="text-xl shadow-white shadow-2xl px-3 bg-yellow-200 text-yellow-800 rounded-full">
                        {t("Ability to adapt quickly")}
                      </div>
                      <div class="text-xl shadow-white shadow-2xl px-3 bg-green-200 text-green-800 rounded-full">
                        {t("Quick acquisition")}
                      </div>
                      <div class="text-xl shadow-white shadow-2xl px-3 bg-teal-200 text-teal-800 rounded-full">
                        {t("Inquisitive, progressive")}
                      </div>
                    </div>
                    {/* </marquee> */}
