  ...
  return (
    <div className='flex w-full flex-col '>
        ...
        <div  className='my-5 md:flex-row min-h-screen flex-col container flex justify-center items-center md:mx-20'>
            ...
            <div data-aos="fade-left" className='flex text-start flex-col mx-3 md:mr-3 my-auto justify-center items-center opacity-100 shadow-2xl border-2 p-5 rounded-tr-full rounded-br-full'>
                <p>
                ...
                <p className='md:text-2xl text-lg font-mono text-black'>
